...
<body>
 <nav class="navbar navbar-expand-lg navbar-light bg-info fixed-top bg-dark">
 ...
 <!-- Sidebar -->
 <div class="col-md-2 bg-info mt-2 pt-4 bg-warning">
 <ul class="nav flex-column ms-3 mb-5">
 <li class="nav-item">
 <a class="nav-link active text-white" href="dashboard.php"><i class="fas fa-tachometer-alt me2"></i>Dashboard</a><hr class="bg-secondary"> </li>
 <li class="nav-item">
...
Dosen</a><hr class="bg-secondary"></li>
 <li class="nav-item">
 <a class="nav-link text-white" href="pegawai.php"><i class="fas fa-users me-2"></i>Daftar Pegawai</a><hr
class="bg-secondary"> </li>
 </ul>
 </div>
 <div class="col-md-10 p-5 pt-2">
 <h3><i class="fas fa-user-graduate me-2"></i> Daftar Dosen</h3><hr>
 ...
 <div class="modal fade" id="tambahDataModal" tabindex="-1" aria-labelledby="tambahDataLabel" aria-hideen="true" >
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="ubah_dosen.php" method="POST">
                    ...
                    <input type="hidden" id="edit-no" name="no">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    editButtons.forEach(button => {
        button.addEventListener('click', function () {
            ...
            document.getElementById('edit-no').value = this.getAttribute('data-no');
